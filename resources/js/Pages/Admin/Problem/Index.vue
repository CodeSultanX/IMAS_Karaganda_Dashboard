                        ...
                        <tr v-for="problem in problems">
                            ...
                            <td>
                                <div class="form-check form-switch ml-10">
                                    <input class="form-check-input" @click="updateProblemVisible(problem)" type="checkbox" role="switch" id="flexSwitchCheckCheckedDisabled" :checked="problem.is_visible"  >
                                </div>
                           </td>
                            <td>{{ problem.title }}</td>
                        ...
                        <form class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form @submit.prevent="storeAction" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="color" v-model="form.color">
                                                ...
                                                <option value="zzz">Нейтральный (без цвета)</option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="name" v-model="form.name"  rows="3"></textarea>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <button type="submit" :disabled="!form.name || !form.status || !form.result || !form.value_regions ||
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form @submit.prevent="updateForm">
                            <div class="modal-body">
                                <div class="form-group">
                                    <label for="name">Найменование</label>
...
import {createProblem,getProblems,updateProblemVisible} from '@/Use/api/problems';
...
export default {
    ...
    methods: {
        ...
        removedFile(file){
            this.form.images = this.form.images.filter(f => f !== file);
        },
